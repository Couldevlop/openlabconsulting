...
describe('Page /laboratoire/axes', () => {
  it('rend un h1 « Six pistes, huit produits »', async () => {
    render(await LaboratoireAxesPage());
    const h1 = screen.getByRole('heading', { level: 1 });
    expect(h1.textContent).toMatch(/Six pistes/i);
  });

  it('affiche tous les axes du dataset RD_AXES', async () => {
    render(await LaboratoireAxesPage());
  ...
  it('expose un lien vers les publications', async () => {
    render(await LaboratoireAxesPage());
