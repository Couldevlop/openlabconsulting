...
export const metadata: Metadata = {
  ...
  description:
    'Cinq questions pour cadrer votre besoin IA, une recommandation adaptée (atelier, audit éclair, cadrage stratégique ou programme), un consultant senior sous 24 h.',
